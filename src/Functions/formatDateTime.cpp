...
private:
    ...
    public:
        ...
        static size_t
        mysqlFractionalSecondSingleZero(char * dest, Time /*source*/, UInt64 fractional_second, UInt32 scale, const DateLUTImpl & /*timezone*/)
        {
            if (scale == 0)
                scale = 1;
            ...
            if (percent_pos < end)
            {
                ...
                switch (*pos)
                {
                    ...
                    case 'f':
                    {
                        ...
                        {
                            instructions.emplace_back(&Instruction<T>::mysqlFractionalSecondSingleZero);
